...
const MOCK_CONTRACTS = [
  {
    id: 'sc-1',
    supplierName: 'Florencia Sarasúa',
    isPrioritySupplier: true,
    contractNumber: 'SC-2026-001',
    startDate: demoDate(-315),
    expirationDate: demoDate(50),
    renewalDate: demoDate(30),
    paymentTerms: 'Net 30',
  ...
  },
  {
    ...
    startDate: demoDate(-680),
    expirationDate: demoDate(-315),
    renewalDate: demoDate(-335),
    paymentTerms: 'Net 30',
    renewalType: 'Auto-notify',
    status: 'Expired',
    weeklyContractedHours: 30,
  ...
  {
    id: 'sc-2',
    supplierName: 'Matías Sarasúa',
    isPrioritySupplier: false,
    contractNumber: 'SC-2025-014',
    startDate: demoDate(-345),
    expirationDate: demoDate(20),
    renewalDate: demoDate(-10),
    paymentTerms: 'Net 15',
    renewalType: 'Manual',
    status: 'Active',
  ...
  {
    id: 'sc-3',
    supplierName: 'Diego Pérez',
    isPrioritySupplier: false,
    contractNumber: 'SC-2025-031',
    startDate: demoDate(-225),
    expirationDate: demoDate(140),
    renewalDate: demoDate(110),
    paymentTerms: 'Net 45',
    renewalType: 'Auto-notify',
    status: 'Active',
    weeklyContractedHours: 25,
    pdfUrl: null,
    archived: false,
    parentContractId: null,
