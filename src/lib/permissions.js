...
const MATRIX = {
  ...
  'clients.deactivate': [ROLES.ADMIN],
  // Projects & Contracts
  'projects.view': ALL,
  ...
  // Triage de horas en Entries (quién paga cada hora) — mismo criterio que
  // projects.edit / assignments.edit.
  'entries.allocate': [ROLES.OPERATIONS, ROLES.ADMIN],
