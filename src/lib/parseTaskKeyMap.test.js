...
test('el id numérico se coerciona a clave string (columna task_number es TEXT)', () => {
  const tasks = [{ id: 22367530000005290, key: 'PP1-T5', name: 'Stage II' }]
  const map = parseTaskKeyMap(tasks)
  assert.deepEqual(map, { '22367530000005290': 'PP1-T5' })
  assert.ok('22367530000005290' in map)
})
