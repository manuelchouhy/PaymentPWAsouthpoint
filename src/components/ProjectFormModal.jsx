...
const FIELDS = [
  ...
  // Budget (base_budget_hours) NO se edita acá: vive en el editor dedicado
  // "Edit Budget Hours" (BudgetHoursModal), que cubre tanto el budget a nivel
  // proyecto (sin stages) como el budget por stage. Editar el proyecto por este
  // form NO toca base_budget_hours (no entra al payload).
]
